export const initialData = [
  ...
  { id: 11, product: "Laptop XZ-2000", date: "2024-06-01", sales: 1700, inventory: 40, category: "Electronics", region: "North" },
  { id: 12, product: "Smart Watch V3", date: "2024-08-10", sales: 1100, inventory: 50, category: "Electronics", region: "East" },
  { id: 13, product: "Ergonomic Chair", date: "2024-09-05", sales: 2300, inventory: 25, category: "Furniture", region: "West" },
  { id: 14, product: "Wireless Earbuds", date: "2024-07-20", sales: 950, inventory: 65, category: "Electronics", region: "South" },
  { id: 15, product: "Coffee Maker", date: "2024-12-10", sales: 850, inventory: 50, category: "Appliances", region: "East" },
  { id: 16, product: "Bluetooth Speaker", date: "2024-11-03", sales: 700, inventory: 80, category: "Electronics", region: "West" },
  { id: 17, product: "Gaming Mouse", date: "2024-10-05", sales: 1500, inventory: 40, category: "Electronics", region: "East" },
  { id: 18, product: "Mechanical Keyboard", date: "2024-11-28", sales: 1600, inventory: 35, category: "Electronics", region: "North" },
  { id: 19, product: "Standing Desk", date: "2024-06-22", sales: 2000, inventory: 25, category: "Furniture", region: "South" },
  { id: 20, product: "Office Desk", date: "2024-10-15", sales: 1400, inventory: 30, category: "Furniture", region: "North" }
